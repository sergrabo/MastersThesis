...
ba.5deg.std.anom <- scaleGrid(ba.5deg, time.frame = "monthly", spatial.frame = "gridbox")#, type = "standardize")
...
mat2d <- array3Dto2Dmat(ba.5deg.std.anom$Data)
...
# Creamos un grafo pesado según la distancia geográfica entre nodos
