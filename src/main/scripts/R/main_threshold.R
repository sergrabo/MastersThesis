...
# Extract components from the output list
rnet <- random_generator_list$rnet
rand.clust_coeff <- random_generator_list$rand.clust_coeff
rand_diam <- random_generator_list$rand_diam
rand.conn <- random_generator_list$rand.conn
